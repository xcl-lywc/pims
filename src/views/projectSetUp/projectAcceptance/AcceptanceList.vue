...
<template>
  <div>
    ...
    <div class="block-wrap">
      <h4 class="block-title">项目受理列表</h4>
          ...
          <el-row>
            <el-col :span="24">
              <el-table :data="tableData.rows" stripe style="width: 100%">
                ...
                <el-table-column prop="processVariables.company" label="申报单位" width="180">
                  <template slot-scope="scope">
                    <span>
                ...
                <el-table-column prop="processVariables.cur_status" label="当前状态" width="">
                  <template slot-scope="scope">
                    <span v-if="scope.row.processVariables.cur_status == 2">待受理</span>
                  </template>
                </el-table-column>
                <el-table-column label="操作" width="250"  fixed="right" header-align="center" align="center">
                  <template slot-scope="scope">
                    ...
                    <el-button type="primary" icon="" size="small" @click.stop="acceptanceClick(scope.row)">受理</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      */
      acceptanceClick(row){
        sessionStorage.setItem("acceptanceId",row.processVariables.projectId)
        sessionStorage.setItem("declareProjectIsEdit",1)
        this.$router.push({path: '/project_set_up/acceptance/project'});
      },
