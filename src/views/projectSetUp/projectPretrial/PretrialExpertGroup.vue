...
<template>
  <div>
    <h2 class="page-title">项目预审</h2>
    <div class="block-wrap">
      <h4 class="block-title">确认预审专家</h4>
        ...
        <div class="body-content">
          <el-row :gutter="20">
            <el-col :span="spanNum" class="left-content">
              ...
              <el-table max-height="400" v-if="dataExpert" :data="dataExpert" stripe border style="width: 100%" @selection-change="handleSelectionChange" ref="multipleTable">
                <el-table-column fixed type="selection" width="50"></el-table-column header-align="center" align="center">
                <!-- <el-table-column type="index" label="专家编号" :index="indexMethod" align="center" class-name="border-index" width="50"></el-table-column> -->
              ...
              <el-table max-height="400" :data="newDataExpert" stripe>
                <!-- <el-table-column fixed type="selection" width="80"></el-table-column header-align="center"> -->
                <!-- <el-table-column type="index" label="专家编号" :index="indexMethod" align="center" class-name="border-index" width="50"></el-table-column> -->
            ...
            <el-col :span="8" :offset="1">
              <div v-if="isShowChoise">
                ...
                <div class="buttons fr">
                  ...
                  <!-- <el-button @click="setCheckedKeys">随机筛选行业</el-button> -->
                </div>
                <div class="clear"></div>
    ...
    methods: {
      ...
      */
      ...
      sureGroup(){
        var formData = {
          tips:"已建立项目预审专家组",
          curStatus:3,
          pretrialExpertArr:this.valueExpert,
          instanceId:JSON.parse(sessionStorage.getItem("rowPretrialInfo")).processVariables.instanceId,
          assignee:JSON.parse(sessionStorage.getItem("rowPretrialInfo")).processVariables.assignee
        }
        if(this.valueExpert.length==0){
          this.$message.warning("你还未建立预审专家组", 20);
          return;
        }
        this.axios.post(`${this.common.basePath}/activiti/complete`,formData).then( (response) => {
          if(response.data.meta.code === 0){
            ...
            this.$router.push({path: '/project_set_up/pretrial'});
          }else{
       ...
       */
      buildExpertGroup(){
        this.$confirm("确认专家组成员并发送预审方案?", "提示", {
      ...
      */
      ...
      setCheckedKeys(){
        ...
        this.$refs.tree.setCheckedKeys(return_array);//设置行业
        this.axios.post(`${this.common.basePath}/hr_users/user/list`,{id:4,industryId:return_array}).then( (response) => {//筛选专家
          if(response.data.meta.code === 0){
            // this.$message.success(response.data.meta.message, 20);
            this.dataExpert = response.data.data
          }else{
