...
<template>
  <div>
    ...
    <div class="block-wrap">
      <!-- <h4 class="block-title">项目查询</h4> -->
      <div class="block-body"> 
        <div class="body-operation">
          <el-form :model="searchForm" ref="searchForm" size="middle" label-width="100px" class="padt10 danwei-form">
            <el-row>
              <el-col :span="12">
                ...
                <el-form-item label="编号：" prop="projectNum">
                  <el-input v-model="searchForm.projectNum" placeholder="请输入项目编号"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
        ...
        <el-row class="body-content" :gutter="20" v-loading="loading">
          <el-col :span="24">
            <el-table :data="tableData.rows" style="width: 100%" @row-click="handleClick">
              ...
              <el-table-column prop="name" label="项目编号" width="120" show-overflow-tooltip>
                <template slot-scope="scope">
                  <span class="cursor-pointer">{{scope.row.projectNum}}</span>
                </template>
              </el-table-column>
              ...
              <el-table-column prop="orgName" label="申报单位" width="">
                <template slot-scope="scope">
              ...
              <!-- <el-table-column prop="budgetMoney" label="已用金额" width="150">
                <template slot-scope="scope">
              ...
              <!-- <el-table-column prop="state" label="项目实施进度" width="300"> 
                <template slot-scope="scope">
...
<script>
  ...
  export default {
    ...
    methods: {
       ...
       */
      getQueryList(){
        this.axios.post(`${this.common.basePath}/project/all`, this._queryListParams() ).then( (response) => {
